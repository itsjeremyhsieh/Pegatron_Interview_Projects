...
def main():
    ...
    parser.add_argument("--subject", type=str, default="Accounting",
                        help="MMMU subject split (e.g., Accounting, Computer_Science)")
    ...
    print(
        f"Final results for {args.model}: accuracy: {results['accuracy']} | {results['correct_str']}")
